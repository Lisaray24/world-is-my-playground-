...
const PACKAGES = [
  {
    id: "cancun-allinclusive",
    title: "Cancún All-Inclusive Escape",
    destination: "Cancún, Mexico",
    duration: "5–7 nights",
    bestFor: "Beach + quick luxury reset",
    fromPrice: "$1,499+",
    image: "/packages/cancun.jpg",
    highlights: ["Adults-only options", "Airport transfers", "Resort credit (when available)"],
  },
  {
    id: "jamaica-allinclusive",
    title: "Jamaica All-Inclusive Getaway",
    destination: "Montego Bay / Negril",
    duration: "4–7 nights",
    bestFor: "Romance + laid-back vibes",
    fromPrice: "$1,399+",
    image: "/packages/jamaica.jpg",
    highlights: ["Oceanfront suites", "Excursion planning", "Private transfers (optional)"],
  },
  {
    id: "punta-cana-allinclusive",
    title: "Punta Cana Luxury All-Inclusive",
    destination: "Punta Cana, Dominican Republic",
    duration: "5–7 nights",
    bestFor: "Value luxury + groups",
    fromPrice: "$1,299+",
    image: "/packages/punta-cana.jpg",
    highlights: ["Family & adults-only", "Butler upgrades", "Group coordination"],
  },
  {
    id: "med-cruise",
    title: "Mediterranean Luxury Cruise",
    destination: "Italy • Greece • Spain (varies)",
    duration: "7–10 nights",
    bestFor: "Bucket-list culture + ocean luxury",
    fromPrice: "$2,499+",
    image: "/packages/med-cruise.jpg",
    highlights: ["Balcony suite options", "Shore excursions", "Pre/post hotel planning"],
  },
  {
    id: "alaska-cruise",
    title: "Alaska Scenic Cruise",
    destination: "Juneau • Skagway • Glacier routes",
    duration: "7 nights",
    bestFor: "Nature + once-in-a-lifetime views",
    fromPrice: "$1,899+",
    image: "/packages/alaska-cruise.jpg",
    highlights: ["Glacier viewing", "Wildlife excursions", "Rail add-ons (optional)"],
  },
  {
    id: "paris-london",
    title: "Paris + London Luxe City Duo",
    destination: "Paris + London",
    duration: "6–9 nights",
    bestFor: "First-class city experience",
    fromPrice: "$2,199+",
    image: "/packages/paris.jpg",
    highlights: ["Boutique hotels", "Rail between cities", "Dining & tickets planning"],
  },
];
